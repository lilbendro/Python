...
demo = Alumno("Borja", "Cabezas", "Rozas") #Instanciamos el alumno DEMO y le pasamos NOMBRE y APELLIDOS
print(demo.Nombre,demo.Apellido1,demo.Apellido2)
print (f"{demo.getNombrecompleto()}")

if (demo.setFechaNacimiento("12-03-1999")):
    print(f"Edad: {demo.getEdad()} años")

demo.setFechaNacimiento("30-09-95") #Asignamos una fecha de nacimiento
print(f"Edad: {demo.getEdad()} años")
